...
import { User, Lock, CheckCircle, ChevronLeft, ChevronRight, MessageSquare, Briefcase, CreditCard, Target, Aperture, Upload, Sliders, ArrowLeft } from 'lucide-react';
    ...
    return (
        <div className="create-account-page middle-content-main">
            <div className="navbar-content-wrapper content-wrapper page-header-wrapper">
                <button className="back-btn" onClick={() => onNavigate(PAGES.HOME)} style={{ display: 'flex', alignItems: 'center', gap: '8px', background: 'none', border: 'none', cursor: 'pointer', color: '#6b7280', marginBottom: '1rem', fontSize: '1rem' }}>
                ...
                <div className="form-navigation">
                    ...
                    {currentStep < steps.length ? (
                        <button
                            ...
                            style={{ background: 'linear-gradient(135deg, #007bff 0%, #00d2ff 100%)', border: 'none' }}
                        >
